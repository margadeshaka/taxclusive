    ...
    try {
        ...
        const emailMessage = {
            ...
            content: {
                ...
                plainText: 'This is a test email to verify Azure Communication Services setup for Taxclusive CA firm website.',
                html: `
...
async function testQueryFormEmail() {
    ...
    try {
        ...
        const formData = {
            ...
            query: 'I need help with GST return filing for my manufacturing business. Can you guide me through the process?'
        };
