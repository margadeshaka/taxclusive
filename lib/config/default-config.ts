...
export const defaultConfig: WebsiteConfiguration = {
  ...
  content: {
    ...
    business: {
      ...
      mission: 'To provide exceptional financial and tax advisory services that empower businesses and individuals to achieve their financial goals through expert guidance, innovative solutions, and unwavering integrity.',
      vision: 'To be the most trusted and preferred chartered accountancy firm in India, recognized for our expertise, client-centric approach, and contribution to the financial success of our clients.',
      values: [
    ...
    pages: {
      home: {
        hero: {
          ...
          description: 'Leading CA firm providing comprehensive tax planning, audit, GST compliance, and financial advisory services. 35+ years of expertise, 500+ satisfied clients across India.',
          primaryCta: {
        ...
        services: {
          ...
          description: 'From tax planning to business advisory, we provide end-to-end chartered accountancy services tailored to your needs.',
          items: [
            {
              id: 'tax-planning',
              name: 'Tax Planning & Preparation',
              description: 'Strategic tax planning and preparation services to minimize your tax liability while ensuring full compliance.',
              icon: 'calculator',
              features: [
            ...
            },
            {
              ...
              description: 'Complete GST registration, compliance, and return filing services for hassle-free tax management.',
              icon: 'file-text',
              features: [
                'GST Registration',
            ...
            },
            {
              ...
              description: 'Independent audit and assurance services to enhance your financial credibility and compliance.',
              icon: 'shield-check',
              features: [
                'Statutory Audit',
                'Internal Audit',
            ...
            },
            {
              ...
              description: 'End-to-end business registration and compliance services for startups and established companies.',
              icon: 'building',
              features: [
            ...
            },
            {
              ...
              description: 'Strategic financial planning and business advisory services to drive your growth.',
              icon: 'trending-up',
              features: [
                'Business Planning',
                'Investment Advisory',
        ...
        expertise: {
          ...
          description: 'Our team brings deep industry knowledge and specialized expertise across multiple sectors.',
          items: [
            {
              id: 'real-estate',
              name: 'Real Estate & Construction',
              description: 'Specialized CA services for real estate developers, construction companies, and property investors.',
              icon: 'home',
            ...
            },
            {
              ...
              description: 'Financial advisory and compliance support for tech startups and established technology companies.',
              icon: 'laptop',
            ...
            },
            {
              ...
              description: 'Comprehensive accounting and tax services for manufacturing and distribution businesses.',
              icon: 'factory',
            ...
            },
            {
              ...
              description: 'Specialized financial services for healthcare providers and life sciences companies.',
              icon: 'heart',
          ...
          items: [
            {
              ...
              content: 'Taxclusive has been instrumental in our company\'s financial success. Their expertise in tax planning has saved us significant amounts while ensuring complete compliance.',
              rating: 5,
            },
            {
              id: 'testimonial-2',
              ...
              content: 'As a startup, we needed reliable financial guidance. Taxclusive provided exceptional support from company registration to ongoing compliance.',
              rating: 5,
            },
            {
              id: 'testimonial-3',
              ...
              content: 'Professional, reliable, and always available when we need them. Their audit services have strengthened our financial processes significantly.',
              rating: 5,
            },
          ],
        },
        ...
        cta: {
          ...
          description: 'Join 500+ satisfied clients who trust Taxclusive for their chartered accountancy needs.',
          primaryButton: {
      ...
      about: {
        ...
        team: {
          ...
          description: 'Our team of qualified chartered accountants brings decades of combined experience and specialized expertise.',
          members: [
            {
              id: 'ca-1',
              name: 'CA Rajesh Sharma',
              role: 'Managing Partner',
              description: 'Leading chartered accountant with 20+ years of experience in tax planning and audit services.',
            ...
            },
            {
              ...
              name: 'CA Priya Gupta',
              role: 'Senior Partner',
              description: 'Expert in GST compliance and business registration with comprehensive industry knowledge.',
          ...
          items: [
            {
              ...
              description: 'We uphold the highest standards of professional integrity and ethical conduct in all our services.',
              icon: 'shield-check',
            },
            {
              id: 'excellence',
              name: 'Professional Excellence',
              description: 'We strive for excellence in every aspect of our work, ensuring quality and accuracy in all deliverables.',
              icon: 'award',
            },
            {
              id: 'client-first',
              name: 'Client-First Approach',
              description: 'Our clients\' success is our priority. We tailor our services to meet their unique needs and objectives.',
              icon: 'users',
            },
            {
              id: 'innovation',
              name: 'Continuous Innovation',
              description: 'We embrace technology and innovative practices to enhance our service delivery and client experience.',
              icon: 'lightbulb',
            },
          ],
        },
      ...
      services: {
        hero: {
          ...
          description: 'From tax planning to business advisory, we offer a complete range of chartered accountancy services designed to support your financial success.',
        },
            ...
            services: [
              {
                ...
                description: 'Comprehensive income tax services including planning, preparation, and filing of returns for individuals and businesses.',
                features: [
              ...
              },
              {
                ...
                description: 'Complete GST services from registration to regular compliance and return filing.',
                features: [
                  'GST Registration',
            ...
            services: [
              {
                ...
                description: 'Mandatory audit services for companies as per regulatory requirements.',
                features: [
      ...
      contact: {
        hero: {
          ...
          description: 'Ready to transform your financial management? Our team of expert chartered accountants is here to help.',
        },
      ...
      faq: {
        hero: {
          ...
          description: 'Get quick answers to the most frequently asked questions about our chartered accountancy services.',
        },
            ...
            questions: [
              {
                ...
                answer: 'For individuals, the deadline is typically July 31st of the assessment year. For businesses requiring audit, it\'s September 30th. However, these dates may be extended by the government in certain circumstances.',
              },
              {
                id: 'gst-registration-required',
                question: 'When is GST registration mandatory?',
                answer: 'GST registration is mandatory when your annual turnover exceeds ₹20 lakhs (₹10 lakhs for northeastern states). It\'s also required for inter-state supply regardless of turnover, and for certain specified services.',
              },
              {
                id: 'tax-saving-investments',
                question: 'What are the best tax-saving investment options?',
                answer: 'Popular tax-saving options under Section 80C include PPF, ELSS mutual funds, life insurance premiums, and home loan principal. Other sections like 80D (health insurance) and 80G (donations) also offer tax benefits.',
              },
            ],
          },
          {
            ...
            questions: [
              {
                ...
                answer: 'With proper documentation, company incorporation typically takes 7-15 business days. The process includes name approval, filing of incorporation documents, and obtaining the Certificate of Incorporation.',
              },
              {
                id: 'audit-requirement',
                question: 'Which companies require statutory audit?',
                answer: 'All companies registered under the Companies Act 2013 require statutory audit, except certain small companies with turnover less than ₹1 crore and borrowings less than ₹50 lakhs.',
              },
            ],
          },
        ],
    ...
    navigation: {
      ...
      footer: {
        description: 'Leading Chartered Accountancy firm providing expert financial and tax advisory services across India.',
        sections: [
          {
            id: 'services',
            title: 'Services',
