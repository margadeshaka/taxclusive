...
export const metadata: Metadata = generateMetadata({
  ...
  keywords: "about us, tax professional team, financial services firm history, professional tax advisors, experienced tax professionals Delhi NCR, financial services legacy, expert financial advisors",
  canonical: "/about",
});
