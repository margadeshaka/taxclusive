              ...
              <div className="flex flex-col items-center space-y-4 text-center">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    We uphold the highest standards of honesty and ethics in every financial
                    decision, ensuring complete transparency and trust in all our engagements.
                  </p>
                </div>
              </div>
              <div className="flex flex-col items-center space-y-4 text-center">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    {" "}
                    We strive for excellence in every service we provide—from audit and tax to
                    financial consulting—ensuring precision and consistent value for our clients.
                  </p>
                </div>
              </div>
              <div className="flex flex-col items-center space-y-4 text-center">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    We build lasting partnerships by understanding each client’s unique needs,
                    offering tailored solutions that support growth, compliance, and success.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-muted-foreground">
                        We take the time to understand your unique financial situation, goals, and
                        challenges.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-muted-foreground">
                        We develop a customized strategy tailored to your specific needs and
                        objectives.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-muted-foreground">
                        We implement the agreed-upon solutions with precision and attention to
                        detail.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-muted-foreground">
                        We continuously monitor progress, provide regular updates, and adjust
