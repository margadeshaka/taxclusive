                    ...
                    <div className="container px-4 md:px-6">
                        <div className="flex flex-col items-center justify-center space-y-4 text-center">
                            <div className="space-y-2">
                                ...
                                <h1 className="text-3xl font-bold tracking-tighter font-serif sm:text-5xl">Contact
                                    Us</h1>
                    ...
                    <div className="container grid items-center gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-10">
                        <div className="space-y-8">
                            <div className="space-y-2">
                                ...
                                <h2 className="text-3xl font-bold tracking-tighter font-serif md:text-4xl/tight">Connect
                                    With Us</h2>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start gap-4">
                                    <Phone
                                        className="h-6 w-6 text-primary relative after:absolute after:content-[''] after:w-full after:h-full after:border after:border-primary/30 after:rounded-full after:-right-1 after:-bottom-1"/>
                                    <div className="space-y-1">
                                        <h3 className="font-bold">Phone</h3>
                                        <p className="text-sm text-muted-foreground">Our team is just a call away to
                                            assist you with tax planning, compliance, and financial solutions.</p>
                                        <p className="text-muted-foreground">Reach us during business hours for prompt
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-sm text-muted-foreground">Visit us at our centrally located
                                            office in Gurugram for expert financial advice and dedicated tax
